...
const ShopsEstablishmentsDetails = () => {
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-3">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl lg:text-4xl font-black tracking-tight uppercase break-words leading-none">
                {data.title || "Shops & Establishments Laws in India"}
              </h1>
            </div>
      ...
      <main className="w-full px-4 lg:px-8 -mt-4 relative z-20">
        <div className="grid grid-cols-12 gap-6 lg:gap-10">
          ...
          <div className="col-span-12 xl:col-span-9 bg-white rounded-[2rem] lg:rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 p-6 lg:p-10 space-y-8 min-w-0">
            ...
            <section id="state-legislation-portal" className="w-full min-w-0 bg-slate-50/70 border border-slate-200/60 p-6 lg:p-8 rounded-[2rem]">
              ...
              <p className="text-sm text-slate-500 pl-6 lg:pl-10 mb-6 font-medium">
                Unlike Central Labour Codes, rules vary by geography. Select a state context to review target compliance structures, workflows, setup frameworks, and checklists:
              </p>
              ...
              <div className="pl-6 lg:pl-10 grid gap-3 sm:grid-cols-1 md:grid-cols-2">
                {dynamicStates.map((state, idx) => (
                  ...
                  >
                    ...
                    <ArrowRight size={16} className="text-slate-400 group-hover:text-orange-500 group-hover:translate-x-1 transition-all flex-shrink-0 ml-2" />
                  </Link>
                ))}
              </div>
            </section>

            {/* DETAILED ACTS SECTIONS BREAKDOWN */}
            ...
            {data.practicalNotes && data.practicalNotes.length > 0 && data.practicalNotes.some(note => note.trim() !== "") && (
              <section id="practical-implementation-section" className="w-full min-w-0 border-l-4 border-amber-100 pl-6 lg:pl-10">
                ...
                <div className="mt-2 w-full">
                  <ul className="space-y-3.5 list-disc list-outside pl-4 text-slate-600 text-[13px] lg:text-[14px] leading-relaxed font-medium">
                    {data.practicalNotes.map((note, i) => note && (
          ...
          <aside className="col-span-12 xl:col-span-3 space-y-6">
            ...
            {/* OPERATIONAL ASSISTANCE QUICK BUTTON */}
            <div className="bg-[#0B1538] p-6 rounded-[2.5rem] text-white shadow-xl">
              ...
              <p className="text-[11px] text-slate-300 leading-relaxed font-medium mb-4">
                Scroll down to look over the isolated FAQ module below for quick operational insights regarding compliance layouts.
              </p>
              <button 
...
export default ShopsEstablishmentsDetails;